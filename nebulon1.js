...
function(t) {
    var e, i, r, n, o, s = t.GreenSockGlobals || t, a = function(t) {
        var e, i = t.split("."), r = s;
        for (e = 0; i.length > e; e++)
            r[i[e]] = r = r[i[e]] || {};
        return r
    }, h = a("com.greensock"), l = [].slice, u = function() {}, c = {}, d = function(e, i, r, n) {
        this.sc = c[e] ? c[e].sc : [],
        c[e] = this,
        this.gsClass = null,
        this.func = r;
        ...
        this.check = function(h) {
            for (var l, u, p, f, m = i.length, v = m; --m > -1; )
                (l = c[i[m]] || new d(i[m],[])).gsClass ? (o[m] = l.gsClass,
                v--) : h && l.sc.push(this);
            if (0 === v && r)
                for (u = ("com.greensock." + e).split("."),
                p = u.pop(),
    ...
    var m = [0, 0, 1, 1]
      ...
      , x = g.register = function(t, e, i, r) {
        for (var n, o, s, a, l = e.split(","), u = l.length, c = (i || "easeIn,easeOut,easeInOut").split(","); --u > -1; )
            ...
            s = c.length; --s > -1; )
                a = c[s],
                y[o + "." + a] = y[a + o] = n[a] = t.getRatio ? t : t[a] || new t
    }
    ;
    for (r = g.prototype,
    r._calcEnd = !1,
    ...
    y.linear = h.easing.Linear.easeIn,
    y.swing = h.easing.Quad.easeInOut;
    ...
    r.addEventListener = function(t, e, i, r, s) {
        s = s || 0;
        var a, h, l = this._listeners[t], u = 0;
        for (null == l && (this._listeners[t] = l = []),
        h = l.length; --h > -1; )
            a = l[h],
            a.c === e && a.s === i ? l.splice(h, 1) : 0 === u && s > a.pr && (u = h + 1);
        l.splice(u, 0, {
            c: e,
            s: i,
            up: r,
    ...
    f("Ticker", function(t, e) {
        var i, r, s, a, h, l = this, c = T(), d = e !== !1 && b, p = function(t) {
            S = T(),
            l.time = (S - c) / 1e3;
            var e, n = l.time - h;
            (!i || n > 0 || t === !0) && (l.frame++,
    ...
    r.eventCallback = function(t, e, i, r) {
        if ("on" === (t || "").substr(0, 2)) {
            ...
            n[t + "Params"] = i instanceof Array && -1 !== i.join("").indexOf("{self}") ? this._swapSelfInParams(i) : i,
            n[t + "Scope"] = r),
    ...
    r.paused = function(t) {
        ...
        if (t != this._paused && this._timeline) {
            ...
            t || 0 === r || 0 === this._duration || this.render(e.smoothChildTiming ? this._totalTime : (i - this._startTime) / this._timeScale, !0, !0)
        }
    ...
    var M = f("TweenLite", function(e, i, r) {
        ...
        var n, o, s, a = e.jquery || e.length && e !== t && e[0] && (e[0] === t || e[0].nodeType && e[0].style && !e.nodeType), h = this.vars.overwrite;
        if (this._overwrite = h = null == h ? I[M.defaultOverwrite] : "number" == typeof h ? h >> 0 : I[h],
        (a || e instanceof Array) && "number" != typeof e[0])
            for (this._targets = s = l.call(e, 0),
            this._propLookup = [],
            this._siblings = [],
            n = 0; s.length > n; n++)
                o = s[n],
                o ? "string" != typeof o ? o.length && o !== t && o[0] && (o[0] === t || o[0].nodeType && o[0].style && !o.nodeType) ? (s.splice(n--, 1),
                this._targets = s = s.concat(l.call(o, 0))) : (this._siblings[n] = U(o, this, !1),
                1 === h && this._siblings[n].length > 1 && X(o, this, null, 1, this._siblings[n])) : (o = s[n--] = M.selector(o),
                "string" == typeof o && s.splice(n + 1, 1)) : s.splice(n--, 1);
        else
            this._propLookup = {},
      ...
      , P = function(t, e) {
        var i, r = {};
        for (i in t)
            k[i] || i in e && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!D[i] || D[i] && D[i]._autoCSS) || (r[i] = t[i],
            delete t[i]);
        t.css = r
    };
    r = M.prototype = new E,
    ...
    E._updateRoot = function() {
        if (N.render((n.time - N._startTime) * N._timeScale, !1, !1),
        ...
        !(n.frame % 120)) {
            ...
            if (i = N._first,
            (!i || i._paused) && M.autoSleep && !B._first && 1 === n._listeners.tick.length) {
                for (; i && i._paused; )
                    i = i._next;
                i || n.sleep()
            }
    ...
    var U = function(t, e, i) {
      ...
      , X = function(t, e, i, r, n) {
        ...
        var l, u = e._startTime + 1e-10, c = [], d = 0, p = 0 === e._duration;
        for (o = n.length; --o > -1; )
            (a = n[o]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (l = l || j(e, 0, p),
            0 === j(a, l, p) && (c[d++] = a)) : u >= a._startTime && a._startTime + a.totalDuration() / a._timeScale + 1e-10 > u && ((p || !a._initted) && 2e-10 >= u - a._startTime || (c[d++] = a)));
        for (o = d; --o > -1; )
            a = c[o],
            2 === r && a._kill(i, t) && (s = !0),
      ...
      , j = function(t, e, i) {
        ...
        return o /= n,
        o > e ? o - e : i && o === e || !t._initted && 2 * s > o - e ? s : (o += t.totalDuration() / t._timeScale / n) > e + s ? 0 : o - e - s
    };
    r._init = function() {
        var t, e, i, r, n = this.vars, o = this._overwrittenProps, s = this._duration, a = n.immediateRender, h = n.ease;
        if (n.startAt) {
            ...
            if (this._startAt)
                ...
                i = {};
                for (r in n)
                    k[r] && "autoCSS" !== r || (i[r] = n[r]);
                return i.overwrite = 0,
                void (this._startAt = M.to(this.target, 0, i))
            }
        if (this._ease = h ? h instanceof g ? n.easeParams instanceof Array ? h.config.apply(h, n.easeParams) : h : "function" == typeof h ? new g(h,n.easeParams) : y[h] || M.defaultEase : M.defaultEase,
    ...
    r._initProps = function(e, i, r, n) {
        ...
        for (o in this.vars) {
            if (u = this.vars[o],
            k[o])
                u instanceof Array && -1 !== u.join("").indexOf("{self}") && (this.vars[o] = u = this._swapSelfInParams(u, this));
                ...
                l.s = l.f ? e[o.indexOf("set") || "function" != typeof e["get" + o.substr(3)] ? o : "get" + o.substr(3)]() : parseFloat(e[o]),
    ...
    r.render = function(t, e, i) {
        ...
        if (t >= this._duration)
            ...
            this._rawPrevTime > 0 && (n = "onReverseComplete",
            e && (t = -1))),
            this._rawPrevTime = t);
        else if (1e-7 > t)
            this._totalTime = this._time = 0,
            this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
            (0 !== s || 0 === this._duration && this._rawPrevTime > 0) && (n = "onReverseComplete",
            r = this._reversed),
            0 > t ? (this._active = !1,
        ...
        this._easeType) {
            ...
            this.ratio = 1 === h ? 1 - a : 2 === h ? a : .5 > t / this._duration ? a / 2 : 1 - a / 2
        } else
        ...
        if (this._time !== s || i) {
            ...
            this.vars.onStart && (0 !== this._time || 0 === this._duration) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || v))),
            o = this._firstPT; o; )
    ...
    r._kill = function(t, e) {
        ...
        if ((e instanceof Array || R(e)) && "number" != typeof e[0])
            ...
            if (s) {
                h = t || s,
                l = t !== r && "all" !== r && t !== s && (null == t || t._tempKill !== !0);
                for (n in h)
                    (o = s[n]) && (o.pg && o.t._kill(h) && (a = !0),
    ...
    p.plugin = function(t) {
        ...
        }, t.global === !0), a = s.prototype = new z(i);
        a.constructor = s,
        s.API = t.API;
        for (e in o)
...
(window._gsQueue || (window._gsQueue = [])).push(function() {
    window._gsDefine("easing.Back", ["easing.Ease"], function(t) {
        var e, i, r, n = window.GreenSockGlobals || window, o = n.com.greensock, s = 2 * Math.PI, a = Math.PI / 2, h = o._class, l = function(e, i) {
        ...
        i = h("easing.RoughEase", function(e) {
            e = e || {};
            for (var i, r, n, o, s, a, h = e.taper || "none", l = [], u = 0, c = 0 | (e.points || 20), p = c, f = e.randomize !== !1, m = e.clamp === !0, v = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; --p > -1; )
                i = f ? Math.random() : 1 / c * p,
                r = v ? v.getRatio(i) : i,
                "none" === h ? n = g : "out" === h ? (o = 1 - i,
                n = o * o * g) : "in" === h ? n = i * i * g : .5 > i ? (o = 2 * i,
                n = .5 * o * o * g) : (o = 2 * (1 - i),
                n = .5 * o * o * g),
...
(window._gsQueue || (window._gsQueue = [])).push(function() {
    window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        var l, u, c, d, p, f, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g, v = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, g = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, y = /[^\d\-\.]/g, x = /(?:\d|\-|\+|=|#|\.)*/g, _ = /opacity *= *([^)]*)/, b = /opacity:([^;]*)/, w = /alpha\(opacity *=.+?\)/i, T = /^(rgb|hsl)/, S = /([A-Z])/g, E = /-([a-z])/gi, A = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, C = function(t, e) {
            return e.toUpperCase()
        }, M = /(?:Left|Right|Width)/i, R = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, P = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, O = /,(?=[^\)]*(?:\(|$))/gi, D = Math.PI / 180, F = 180 / Math.PI, L = {}, k = document, I = k.createElement("div"), B = k.createElement("img"), N = s._internals = {
            _specialProps: a
        }, U = navigator.userAgent, X = function() {
            var t, e = U.indexOf("Android"), i = k.createElement("div");
            return c = -1 !== U.indexOf("Safari") && -1 === U.indexOf("Chrome") && (-1 === e || Number(U.substr(e + 8, 1)) > 3),
        ...
        , V = s.getStyle = function(t, e, i, r, n) {
            var o;
            return X || "opacity" !== e ? (!r && t.style[e] ? o = t.style[e] : (i = i || H(t, null)) ? (t = i.getPropertyValue(e.replace(S, "-$1").toLowerCase()),
            o = t || i.length ? t : i[e]) : t.currentStyle && (i = t.currentStyle,
            o = i[e]),
            null == n || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : n) : j(t)
        }
        , q = function(t, e, i, r, n) {
            ...
            if ("auto" === r || !i)
                return 0;
            var o, s = M.test(e), a = t, h = I.style, l = 0 > i;
            return l && (i = -i),
            "%" === r && -1 !== e.indexOf("border") ? o = i / 100 * (s ? t.clientWidth : t.clientHeight) : (h.cssText = "border-style:solid; border-width:0; position:absolute; line-height:0;",
            "%" !== r && a.appendChild ? h[s ? "borderLeftWidth" : "borderTopWidth"] = i + r : (a = t.parentNode || k.body,
            ...
            for (s in i)
                "cssText" !== s && "length" !== s && isNaN(s) && (e[s] !== (o = i[s]) || n && n[s]) && -1 === s.indexOf("Origin") && ("number" == typeof o || "string" == typeof o) && (h[s] = "auto" !== o || "left" !== s && "top" !== s ? "" !== o && "auto" !== o && "none" !== o || "string" != typeof e[s] || "" === e[s].replace(y, "") ? o : 0 : K(t, s),
            ...
            width: ["Left", "Right"],
            height: ["Top", "Bottom"]
        }, Z = ["marginLeft", "marginRight", "marginTop", "marginBottom"], te = function(t, e, i) {
            ...
            var n, o, s, a, h = 1e-6;
            return null == t ? a = e : "number" == typeof t ? a = t * D : (n = 2 * Math.PI,
            o = t.split("_"),
            s = Number(o[0].replace(y, "")) * (-1 === t.indexOf("rad") ? D : 1) - ("=" === t.charAt(1) ? 0 : e),
            o.length && (r && (r[i] = e + s),
            -1 !== t.indexOf("short") && (s %= n,
            s !== s % (n / 2) && (s = 0 > s ? s + n : s - n)),
            -1 !== t.indexOf("_cw") && 0 > s ? s = (s + 9999999999 * n) % n - (0 | s / n) * n : -1 !== t.indexOf("ccw") && s > 0 && (s = (s - 9999999999 * n) % n - (0 | s / n) * n)),
            a = e + s),
            h > a && a > -h && (a = 0),
            a
        }, oe = {
        ...
        var le = function(t, e, i, r) {
            if (null == t)
                ...
                ;
            var n, o = e ? (t.match(he) || [""])[0] : "", s = t.split(o).join("").match(g) || [], a = t.substr(0, t.indexOf(s[0])), h = ")" === t.charAt(t.length - 1) ? ")" : "", l = -1 !== t.indexOf(" ") ? " " : ",", u = s.length, c = u > 0 ? s[0].replace(m, "") : "";
          ...
          , ce = (N._setPluginRatio = function(t) {
            ...
            for (var e, i, r, n, o = this.data, s = o.proxy, a = o.firstMPT, h = 1e-6; a; )
                e = s[a.v],
                a.r ? e = e > 0 ? 0 | e + .5 : 0 | e - .5 : h > e && e > -h && (e = 0),
                a.t[a.p] = e,
                a = a._next;
        ...
        function(t, e, i, r, n) {
          ...
          , de = (N._parseToProxy = function(t, e, i, r, n, o) {
            var s, a, h, l, u, c = r, d = {}, p = {}, f = i._transform, m = L;
        ...
        N.CSSPropTween = function(t, e, r, n, s, a, h, l, u, c, d) {
          ...
          , pe = s.parseComplex = function(t, e, i, r, n, o, s, a, h, u) {
            ...
            r += "";
            var c, d, p, f, g, y, x, _, b, w, S, E, A = i.split(", ").join(",").split(" "), C = r.split(", ").join(",").split(" "), M = A.length, R = l !== !1;
            for ((-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && (A = A.join(" ").replace(O, ", ").split(" "),
            C = C.join(" ").replace(O, ", ").split(" "),
            M = A.length),
            M !== C.length && (A = (o || "").split(" "),
            M = A.length),
            s.plugin = h,
            s.setRatio = u,
            c = 0; M > c; c++)
                ...
                _ || 0 === _)
                    ...
                    b && !X && 0 === g[3] ? (s["xs" + s.l] += s.l ? " transparent" : "transparent",
                    s.e = s.e.split(C[c]).join("transparent")) : (X || (b = !1),
                    s.appendXtra(b ? "rgba(" : "rgb(", f[0], g[0] - f[0], ",", !0, !0).appendXtra("", f[1], g[1] - f[1], ",", !0).appendXtra("", f[2], g[2] - f[2], b ? "," : E, !0),
                    b && (f = 4 > f.length ? 1 : f[3],
                    s.appendXtra("", f, (4 > g.length ? 1 : g[3]) - f, E, !1)));
                else if (y = f.match(m)) {
                    if (x = g.match(v),
                    !x || x.length !== y.length)
                        return s;
                    ...
                    d = 0; y.length > d; d++)
                        S = y[d],
                        w = f.indexOf(S, p),
                        s.appendXtra(f.substr(p, w - p), Number(S), ie(x[d], S), "", R && "px" === f.substr(w + S.length, 2), 0 === d),
                        p = w + S.length;
                    s["xs" + s.l] += f.substr(p)
                } else
                    s["xs" + s.l] += s.l ? " " + f : f;
        ...
        h.appendXtra = function(t, e, i, r, n, o) {
            ...
            s.rxp["xn" + a] = n,
            s["xn" + a] = e,
            s.plugin || (s.xfirst = new de(s,"xn" + a,e,i,s.xfirst || s,0,s.n,n,s.pr),
            s.xfirst.xs0 = 0),
            s) : (s.data = {
                s: e + i
            },
        ...
        var me = function(t, e) {
          ...
          , ve = N._registerComplexSpecialProp = function(t, e, i) {
            ...
            var r, n, o = t.split(","), s = e.defaultValue;
            for (i = i || [s],
            r = 0; o.length > r; r++)
            ...
            if (!a[t]) {
                ...
                ve(t, {
                    parser: function(t, i, r, n, o, s, h) {
                        ...
                        a[r].parse(t, i, r, n, o, s, h)) : (z("Error: " + e + " js file not loaded."),
                        o)
                    }
                })
            }
        ...
        h.parseComplex = function(t, e, i, r, n, o) {
            ...
            if (this.multi && (O.test(i) || O.test(e) ? (a = e.replace(O, "|").split("|"),
            h = i.replace(O, "|").split("|")) : d && (a = [e],
            h = [i])),
            h) {
        ...
        var ye = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(",")
          ...
          , Te = function(t, e, i) {
            var r, n, o, a, h, l, u, c, d, p, f, m, v, g = i ? t._gsTransform || {
                ...
                skewY: 0
            }, y = 0 > g.scaleX, x = 2e-5, _ = 1e5, b = -Math.PI + 1e-4, w = Math.PI - 1e-4, T = we ? parseFloat(V(t, be, e, !1, "0 0 0").split(" ")[2]) || g.zOrigin || 0 : 0;
            if (xe)
                r = V(t, _e, e, !0);
            else if (t.currentStyle)
                if (r = t.currentStyle.filter.match(R),
                r && 4 === r.length)
                    r = [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), g.x || 0, g.y || 0].join(",");
                else {
                    if (null != g.x)
                        return g;
                    r = ""
            ...
            o = n.length; --o > -1; )
                a = Number(n[o]),
                n[o] = (h = a - (a |= 0)) ? (0 | h * _ + (0 > h ? -.5 : .5)) / _ + a : a;
            if (16 === n.length) {
                var S = n[8]
                  , E = n[9]
                  , A = n[10]
                  ...
                  , M = n[13]
                  , P = n[14];
                if (g.zOrigin && (P = -g.zOrigin,
                C = S * P - n[12],
                M = E * P - n[13],
                P = A * P + g.zOrigin - n[14]),
                !i || null == g.rotationX) {
                    var O, D, F, L, k, I, B, N = n[0], U = n[1], X = n[2], j = n[3], z = n[4], Y = n[5], W = n[6], G = n[7], H = n[11], q = g.rotationX = Math.atan2(W, A), K = b > q || q > w;
                    q && (L = Math.cos(-q),
                    k = Math.sin(-q),
                    O = z * L + S * k,
                    D = Y * L + E * k,
                    ...
                    W = X * -k + W * L,
                    U = D),
                    B && K ? g.rotation = g.rotationX = 0 : B && I ? g.rotation = g.rotationY = 0 : I && K && (g.rotationY = g.rotationX = 0),
                    g.scaleX = (0 | Math.sqrt(N * N + U * U) * _ + .5) / _,
                    g.scaleY = (0 | Math.sqrt(Y * Y + E * E) * _ + .5) / _,
                    g.scaleZ = (0 | Math.sqrt(W * W + A * A) * _ + .5) / _,
                    g.skewX = 0,
                ...
                Math.abs(d) > Math.PI / 2 && Math.abs(d) < 1.5 * Math.PI && (y ? (l *= -1,
                d += 0 >= c ? Math.PI : -Math.PI,
                c += 0 >= c ? Math.PI : -Math.PI) : (u *= -1,
                d += 0 >= d ? Math.PI : -Math.PI)),
                m = (c - g.rotation) % Math.PI,
                v = (d - g.skewX) % Math.PI,
                (void 0 === g.skewX || p > x || -x > p || f > x || -x > f || m > b && w > m && !1 | m * _ || v > b && w > v && !1 | v * _) && (g.scaleX = l,
                g.scaleY = u,
                g.rotation = c,
                g.skewX = d),
                we && (g.rotationX = g.rotationY = g.z = 0,
          ...
          , Se = function(t) {
            var e, i, r = this.data, n = -r.rotation, o = n + r.skewX, s = 1e5, a = (0 | Math.cos(n) * r.scaleX * s) / s, h = (0 | Math.sin(n) * r.scaleX * s) / s, l = (0 | Math.sin(o) * -r.scaleY * s) / s, u = (0 | Math.cos(o) * r.scaleY * s) / s, c = this.t.style, d = this.t.currentStyle;
            if (d) {
                i = h,
                h = -l,
                l = -i,
                e = d.filter,
                c.filter = "";
                var p, m, v = this.t.offsetWidth, g = this.t.offsetHeight, y = "absolute" !== d.position, b = "progid:DXImageTransform.Microsoft.Matrix(M11=" + a + ", M12=" + h + ", M21=" + l + ", M22=" + u, w = r.x, T = r.y;
                if (null != r.ox && (p = (r.oxp ? .01 * v * r.ox : r.ox) - v / 2,
                m = (r.oyp ? .01 * g * r.oy : r.oy) - g / 2,
                w += p - (p * a + m * h),
                T += m - (p * l + m * u)),
                y)
                    p = v / 2,
                    ...
                    fe = 0; 4 > fe; fe++)
                        ...
                        A = i !== r[E] ? 2 > fe ? -r.ieOffsetX : -r.ieOffsetY : 2 > fe ? p - r.ieOffsetX : m - r.ieOffsetY,
                ...
                (0 === t || 1 === t) && 1 === a && 0 === h && 0 === l && 1 === u && (y && -1 === b.indexOf("Dx=0, Dy=0") || _.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf("gradient(") && c.removeAttribute("filter"))
            }
        }
          , Ee = function() {
            var t, e, i, r, n, o, s, a, h, l = this.data, u = this.t.style, c = l.perspective, p = l.scaleX, f = 0, m = 0, v = 0, g = 0, y = l.scaleY, x = 0, _ = 0, b = 0, w = 0, T = l.scaleZ, S = 0, E = 0, A = 0, C = c ? -1 / c : 0, M = l.rotation, R = l.zOrigin, P = 1e5;
            d && (s = u.top ? "top" : u.bottom ? "bottom" : parseFloat(V(this.t, "top", null, !1)) ? "bottom" : "top",
            i = V(this.t, s, null, !1),
            a = parseFloat(i) || 0,
            h = i.substr((a + "").length) || "px",
            l._ffFix = !l._ffFix,
            u[s] = (l._ffFix ? a + .05 : a - .05) + h),
            (M || l.skewX) && (i = p * Math.cos(M),
            r = y * Math.sin(M),
            M -= l.skewX,
            f = p * -Math.sin(M),
            y *= Math.cos(M),
            ...
            _ = x * S,
            S = T * S + R),
            v = (i = (v += l.x) - (v |= 0)) ? (0 | i * P + (0 > i ? -.5 : .5)) / P + v : v,
            _ = (i = (_ += l.y) - (_ |= 0)) ? (0 | i * P + (0 > i ? -.5 : .5)) / P + _ : _,
            S = (i = (S += l.z) - (S |= 0)) ? (0 | i * P + (0 > i ? -.5 : .5)) / P + S : S,
            u[xe] = "matrix3d(" + [(0 | p * P) / P, (0 | g * P) / P, (0 | b * P) / P, (0 | E * P) / P, (0 | f * P) / P, (0 | y * P) / P, (0 | w * P) / P, (0 | A * P) / P, (0 | m * P) / P, (0 | x * P) / P, (0 | T * P) / P, (0 | C * P) / P, v, _, S, c ? 1 + -S / c : 1].join(",") + ")"
        }
          , Ae = function() {
            var t, e, i, r, n, o, s, a, h, l = this.data, u = this.t, c = u.style;
            d && (t = c.top ? "top" : c.bottom ? "bottom" : parseFloat(V(u, "top", null, !1)) ? "bottom" : "top",
            e = V(u, t, null, !1),
            i = parseFloat(e) || 0,
            r = e.substr((i + "").length) || "px",
            l._ffFix = !l._ffFix,
            c[t] = (l._ffFix ? i + .05 : i - .05) + r),
            l.rotation || l.skewX ? (n = l.rotation,
            o = n - l.skewX,
            s = 1e5,
            a = l.scaleX * s,
            h = l.scaleY * s,
            c[xe] = "matrix(" + (0 | Math.cos(n) * a) / s + "," + (0 | Math.sin(n) * a) / s + "," + (0 | Math.sin(o) * -h) / s + "," + (0 | Math.cos(o) * h) / s + "," + l.x + "," + l.y + ")") : c[xe] = "matrix(" + l.scaleX + ",0,0," + l.scaleY + "," + l.x + "," + l.y + ")"
        };
        ve("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation", {
            parser: function(t, e, i, r, o, s, a) {
                if (r._transform)
                    return o;
                var h, l, u, c, d, p, f, m = r._transform = Te(t, n, !0), v = t.style, g = 1e-6, y = ye.length, x = a, _ = {};
                if ("string" == typeof x.transform && xe)
                    ...
                    null != f)
                        if ("object" == typeof f)
                            ...
                            x.rotation = f;
                    h.rotation = ne("rotation"in x ? x.rotation : "shortRotation"in x ? x.shortRotation + "_short" : "rotationZ"in x ? x.rotationZ : m.rotation * F, m.rotation, "rotation", _),
                    we && (h.rotationX = ne("rotationX"in x ? x.rotationX : "shortRotationX"in x ? x.shortRotationX + "_short" : m.rotationX * F || 0, m.rotationX, "rotationX", _),
                    h.rotationY = ne("rotationY"in x ? x.rotationY : "shortRotationY"in x ? x.shortRotationY + "_short" : m.rotationY * F || 0, m.rotationY, "rotationY", _)),
                ...
                for (d = m.z || m.rotationX || m.rotationY || h.z || h.rotationX || h.rotationY || h.perspective,
                d || null == x.scale || (h.scaleZ = 1); --y > -1; )
                    i = ye[y],
                    c = h[i] - m[i],
                    (c > g || -g > c || null != L[i]) && (p = !0,
                    o = new de(m,i,m[i],c,o),
                    i in _ && (o.e = _[i]),
                    o.xs0 = 0,
                    o.plugin = s,
                    r._overwriteProps.push(o.n));
                return c = x.transformOrigin,
                (c || we && d && m.zOrigin) && (xe ? (p = !0,
                c = (c || V(t, i, n, !1, "50% 50%")) + "",
                i = be,
                ...
                o.b = u,
                o.xs0 = o.e = m.zOrigin) : o.xs0 = o.e = v[i] = c) : ee(c + "", m)),
        ...
        ve("borderRadius", {
            ...
            parser: function(t, e, i, o, s) {
                e = this.format(e);
                var a, h, l, u, c, d, p, f, m, v, g, y, x, _, b, w, T = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], S = t.style;
                ...
                h = 0; T.length > h; h++)
                    ...
                    y = c.substr((p + "").length),
                    x = "=" === d.charAt(1),
                    x ? (f = parseInt(d.charAt(0) + "1", 10),
                    d = d.substr(2),
                    f *= parseFloat(d),
                    g = d.substr((f + "").length - (0 > f ? 1 : 0)) || "") : (f = parseFloat(d),
                    g = d.substr((f + "").length)),
                    "" === g && (g = r[i] || y),
                    g !== y && (_ = q(t, "borderLeft", p, y),
                    b = q(t, "borderTop", p, y),
                    "%" === g ? (c = 100 * (_ / m) + "%",
                    u = 100 * (b / v) + "%") : "em" === g ? (w = q(t, "borderLeft", 1, "em"),
                    c = _ / w + "em",
                    u = b / w + "em") : (c = _ + "px",
                    u = b + "px"),
                    x && (d = parseFloat(c) + f + g,
                    l = parseFloat(u) + f + g)),
        ...
        ve("backgroundPosition", {
            ...
            parser: function(t, e, i, r, o, s) {
                var a, h, l, u, c, d, p = "background-position", m = n || H(t, null), v = this.format((m ? f ? m.getPropertyValue(p + "-x") + " " + m.getPropertyValue(p + "-y") : m.getPropertyValue(p) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), g = this.format(e);
                if (-1 !== v.indexOf("%") != (-1 !== g.indexOf("%")) && (d = V(t, "backgroundImage").replace(A, ""),
                d && "none" !== d)) {
                    for (a = v.split(" "),
                    h = g.split(" "),
                    ...
                    l = 2; --l > -1; )
                        v = a[l],
                        u = -1 !== v.indexOf("%"),
                        u !== (-1 !== h[l].indexOf("%")) && (c = 0 === l ? t.offsetWidth - B.width : t.offsetHeight - B.height,
        ...
        ve("clip", {
            ...
            parser: function(t, e, i, r, o, s) {
                ...
                e = this.format(e).split(",").join(l)) : (a = this.format(V(t, this.p, n, !1, this.dflt)),
                e = this.format(e)),
        ...
        var Ce = function(t) {
            var e, i = this.t, r = i.filter, n = 0 | this.s + this.c * t;
            100 === n && (-1 === r.indexOf("atrix(") && -1 === r.indexOf("radient(") ? (i.removeAttribute("filter"),
            e = !V(this.data, "filter")) : (i.filter = r.replace(w, ""),
            e = !0)),
            e || (this.xn1 && (i.filter = r = r || "alpha(opacity=100)"),
            -1 === r.indexOf("opacity") ? i.filter += " alpha(opacity=" + n + ")" : i.filter = r.replace(_, "opacity=" + n))
        };
        ve("opacity,alpha,autoAlpha", {
            defaultValue: "1",
            parser: function(t, e, i, r, o, s) {
                var a, h = parseFloat(V(t, "opacity", n, !1, "1")), l = t.style;
                return e = parseFloat(e),
                "autoAlpha" === i && (a = V(t, "visibility", n),
                1 === h && "hidden" === a && 0 !== e && (h = 0),
                o = new de(l,"visibility",0,0,o,-1,null,!1,0,0 !== h ? "visible" : "hidden",0 === e ? "hidden" : "visible"),
                o.xs0 = "visible",
                r._overwriteProps.push(o.n)),
                X ? o = new de(l,"opacity",h,e - h,o) : (o = new de(l,"opacity",100 * h,100 * (e - h),o),
        ...
        ve("className", {
            parser: function(t, e, r, o, s, a, h) {
                var l, u, c, d, p, f = t.className, m = t.style.cssText;
                if (s = o._classNamePT = new de(t,r,0,0,s,2),
                s.setRatio = Re,
                s.pr = -11,
                i = !0,
                s.b = f,
        ...
        var Pe = function(t) {
            if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration)
                for (var e, i = "all" === this.e, r = this.t.style, n = i ? r.cssText.split(";") : this.e.split(","), o = n.length, s = a.transform.parse; --o > -1; )
                    e = n[o],
        ...
        h._onInitTween = function(t, e, a) {
            ...
            this._transformType) {
                ...
                xe ? c && (u = !0,
                "" === w.zIndex && (y = V(t, "zIndex", n),
                ("auto" === y || "" === y) && (w.zIndex = 0)),
                p && (w.WebkitBackfaceVisibility = this._vars.WebkitBackfaceVisibility || (_ ? "visible" : "hidden"))) : w.zoom = 1,
                f = d; f && f._next; )
                    f = f._next;
        ...
        h.parse = function(t, e, i, o) {
            ...
            for (s in e)
                p = e[s],
                h = a[s],
                h ? i = h.parse(t, p, s, this, i, o, e) : (d = V(t, s, n) + "",
                v = "string" == typeof p,
                "color" === s || "fill" === s || "stroke" === s || -1 !== s.indexOf("Color") || v && T.test(p) ? (v || (p = ae(p),
                p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"),
                i = pe(y, s, d, p, !0, "transparent", i, 0, o)) : !v || -1 === p.indexOf(" ") && -1 === p.indexOf(",") ? (u = parseFloat(d),
                f = u || 0 === u ? d.substr((u + "").length) : "",
                ("" === d || "auto" === d) && ("width" === s || "height" === s ? (u = te(t, s, n),
                f = "px") : "left" === s || "top" === s ? (u = K(t, s, n),
                ...
                f !== m && "" !== m && (c || 0 === c) && (u || 0 === u) && (u = q(t, s, u, f),
                "%" === m ? (u /= q(t, s, 100, "%") / 100,
                u > 100 && (u = 100),
                e.strictUnits !== !0 && (d = u + "%")) : "em" === m ? u /= q(t, s, 1, "em") : (c = q(t, s, c, m),
                m = "px"),
                g && (c || 0 === c) && (p = c + u + m)),
                g && (c += u),
                !u && 0 !== u || !c && 0 !== c ? p || "NaN" != p + "" && null != p ? (i = new de(y,s,c || u || 0,0,i,-1,"css_" + s,!1,0,d,p),
                i.xs0 = "none" !== p || "display" !== s && -1 === s.indexOf("Style") ? p : d) : z("invalid " + s + " tween value: " + e[s]) : (i = new de(y,s,u,c - u,i,0,"css_" + s,l !== !1 && ("px" === m || "zIndex" === s),0,d,p),
                i.xs0 = m)) : i = pe(y, s, d, p, !0, null, i, 0, o)),
        ...
        h.setRatio = function(t) {
            ...
            if (1 !== t || this._tween._time !== this._tween._duration && 0 !== this._tween._time)
                if (t || this._tween._time !== this._tween._duration && 0 !== this._tween._time || this._tween._rawPrevTime === -1e-6)
                    for (; n; ) {
                        if (e = n.c * t + n.s,
                        n.r ? e = e > 0 ? 0 | e + .5 : 0 | e - .5 : o > e && e > -o && (e = 0),
                        n.type)
                            if (1 === n.type)
                                if (r = n.l,
                                2 === r)
        ...
        h._kill = function(e) {
            ...
            if (e.css_autoAlpha || e.css_alpha) {
                ...
                for (r in e)
                    o[r] = e[r];
                o.css_opacity = 1,
                o.css_autoAlpha && (o.css_visibility = 1)
            }
            return e.css_className && (i = this._classNamePT) && (n = i.xfirst,
        ...
        return s.cascadeTo = function(t, i, r) {
            var n, o, s, a = e.to(t, i, r), h = [a], l = [], u = [], c = [], d = e._internals.reservedProps;
...
!function() {
    ...
    if (u.prototype = {
        load: function() {
            ...
            for (var n = 0; n < e._urls.length; n++) {
                ...
                if (e._format)
                    ...
                    if (s = e._urls[n].toLowerCase().split("?")[0],
                    o = s.match(/.+\.([^?]+)(\?|$)/),
        ...
        play: function(t, i) {
            ...
            r._loaded ? r._sprite[t] ? (r._inactiveNode(function(n) {
                n._sprite = t;
                var o, s = n._pos > 0 ? n._pos : r._sprite[t][0] / 1e3, h = r._sprite[t][1] / 1e3 - n._pos, l = !(!r._loop && !r._sprite[t][2]), u = "string" == typeof i ? i : Math.round(Date.now() * Math.random()) + "";
                if (function() {
                    var e = {
                        id: u,
                        sprite: t,
                ...
                r._webAudio) {
                    ...
                    void 0 === n.bufferSource.start ? n.bufferSource.noteGrainOn(0, s, h) : n.bufferSource.start(0, s, h)
                } else {
                    if (4 !== n.readyState)
                        return r._clearEndTimer(o),
                        function() {
                            var e = r
                              , o = t
                              , s = i
                              ...
                              , h = function() {
                                e.play(o, s),
                                a.removeEventListener("canplaythrough", h, !1)
                            };
        ...
        pause: function(t, e) {
            ...
            if (r)
                if (r._pos = i.pos(null, t),
                i._webAudio) {
                    if (!r.bufferSource)
                        return i;
                    r.paused = !0,
                    void 0 === r.bufferSource.stop ? r.bufferSource.noteOff(0) : r.bufferSource.stop(0)
                } else
                    r.pause();
            return i.on("pause"),
            i
        ...
        mute: function(t) {
            ...
            return i && (e._webAudio ? i.gain.value = 0 : i.volume = 0),
            e
        },
        unmute: function(t) {
            var e = this;
            if (!e._loaded)
                ...
                e;
            var i = t ? e._nodeById(t) : e._activeNode();
            return i && (e._webAudio ? i.gain.value = e._volume : i.volume = e._volume),
            e
        },
        volume: function(t, e) {
            var i = this;
            ...
            t >= 0 && 1 >= t) {
                ...
                return r && (i._webAudio ? r.gain.value = t : r.volume = t * a.volume()),
                i
            }
            return i._volume
        },
        loop: function(t) {
            var e = this;
            return "boolean" == typeof t ? (e._loop = t,
            e) : e._loop
        },
        sprite: function(t) {
            var e = this;
            return "object" == typeof t ? (e._sprite = t,
            e) : e._sprite
        },
        pos: function(t, i) {
            var r = this;
            ...
            if (n)
                return r._webAudio ? t >= 0 ? (n._pos = t,
                r.pause(i).play(n._sprite, i),
                r) : n._pos + (e.currentTime - r._playStart) : t >= 0 ? (n.currentTime = t,
                r) : n.currentTime;
            if (t >= 0)
                return r;
        ...
        _inactiveNode: function(t) {
            ...
            !i) {
                var n;
                e._webAudio ? (n = e._setupAudioNode(),
                t(n)) : (e.load(),
        ...
        _drainPool: function() {
            ...
            for (t = e._audioNode.length - 1; t >= 0 && !(5 >= i); t--)
                e._audioNode[t].paused && (e._webAudio && e._audioNode[t].disconnect(0),
                i--,
        ...
        _clearEndTimer: function(t) {
            ...
            i = i >= 0 ? i : 0,
            e._onendTimer[i] && (clearTimeout(e._onendTimer[i]),
            e._onendTimer.splice(i, 1))
        },
        _setupAudioNode: function() {
            var t = this
              , i = t._audioNode
              , r = t._audioNode.length;
            return i[r] = void 0 === e.createGain ? e.createGainNode() : e.createGain(),
    ...
    i)
        var c = function(i, r) {
          ...
          , p = function(i, r, n) {
            ...
            r[0] && (o.bufferSource.loopStart = r[1],
...
!function(t) {
    ...
    return function e(t, i, r) {
        ...
        5: [function(e, i, r) {
            !function() {
                ...
                function o(t, e, i, r) {
                    if (!i)
                        return [];
                    var n, s, a, h, l, u, c, d = [], p = e.length, f = e[r], m = e[r + 1];
                    if (r === p && i._listeners) {
                        if ("function" == typeof i._listeners)
                            return t && t.push(i._listeners),
                            [i];
                        for (n = 0,
                        s = i._listeners.length; s > n; n++)
                    ...
                    if ("*" === f || "**" === f || i[f]) {
                        if ("*" === f) {
                            for (a in i)
                                "_listeners" !== a && i.hasOwnProperty(a) && (d = d.concat(o(t, e, i[a], r + 1)));
                            return d
                        }
                        if ("**" === f) {
                            c = r + 1 === p || r + 2 === p && "*" === m,
                            ...
                            for (a in i)
                                "_listeners" !== a && i.hasOwnProperty(a) && ("*" === a || "**" === a ? (i[a]._listeners && !c && (d = d.concat(o(t, e, i[a], p))),
                                d = d.concat(o(t, e, i[a], r))) : d = d.concat(a === m ? o(t, e, i[a], r + 2) : o(t, e, i[a], r)));
                            return d
                        }
                    ...
                    l = i["**"])
                        if (p > r) {
                            ...
                            for (a in l)
                                "_listeners" !== a && l.hasOwnProperty(a) && (a === m ? o(t, e, l[a], r + 2) : a === f ? o(t, e, l[a], r + 1) : (u = {},
                                u[a] = l[a],
                                o(t, e, {
                                    "**": u
                                }, r + 1)))
                        } else
                            l._listeners ? o(t, e, l, p) : l["*"] && l["*"]._listeners && o(t, e, l["*"], p);
                    return d
                }
                function s(t, e) {
                    ...
                    for (var n = this.listenerTree, o = t.shift(); o; ) {
                        ...
                        0 === t.length) {
                            if (n._listeners) {
                                ...
                                else if (a(n._listeners) && (n._listeners.push(e),
                                !n._listeners.warned)) {
                                    var s = h;
                ...
                n.prototype.emit = function() {
                    ...
                    if (this._all) {
                        for (var i = arguments.length, r = new Array(i - 1), n = 1; i > n; n++)
                            r[n - 1] = arguments[n];
                        for (n = 0,
                        i = this._all.length; i > n; n++)
                            this.event = t,
                            this._all[n].apply(this, r)
                    }
                ...
                n.prototype.on = function(t, i) {
                    ...
                    if (this._events[t]) {
                        ...
                        else if (a(this._events[t]) && (this._events[t].push(i),
                ...
                n.prototype.off = function(t, e) {
                    ...
                    for (var s = 0; s < r.length; s++) {
                        ...
                        a(i)) {
                            ...
                            if (0 > l)
                                continue;
                            return this.wildcard ? h._listeners.splice(l, 1) : this._events[t].splice(l, 1),
                ...
                n.prototype.listeners = function(t) {
                    if (this.wildcard) {
                        ...
                        return o.call(this, i, r, this.listenerTree, 0),
                        i
                    }
                    return this._events || e.call(this),
        ...
        6: [function(t, e) {
            ...
            e.exports = i,
            i.prototype.add = i.prototype.enqueue = function(t, e, i, r) {
                if ("function" == typeof i && (r = i,
                i = null),
                this.resources[t])
                    throw new Error('Resource with name "' + t + '" already exists.');
                return this.resources[t] = new n(t,this.baseUrl + e,i),
                "function" == typeof r && this.resources[t].once("afterMiddleware", r),
                this.queue.started ? (this.queue.push(this.resources[t]),
                this._progressChunk = (100 - this.progress) / (this.queue.length() + this.queue.running())) : (this._buffer.push(this.resources[t]),
            ...
            i.prototype.loadResource = function(t, e) {
                ...
                this._runMiddleware(t, this._beforeMiddleware, function() {
                    t.once("complete", i._onLoad.bind(i, t, e)),
                    t.load()
                })
            }
            ,
        ...
        7: [function(t, e) {
            ...
            i.prototype._loadXhr = function() {
				...
				console.log(this.url,this.xhrType) //  blob
            ...
            i.prototype._xhrOnError = function(t) {
                this.error = new Error(r(t.target) + " Request failed. Status: " + t.target.status + ', text: "' + t.target.statusText + '"'),
                this.complete()
            }
            ,
            i.prototype._xhrOnAbort = function(t) {
                this.error = new Error(r(t.target) + " Request was aborted by the user."),
                this.complete()
            }
            ,
            ...
            i.prototype._xhrOnLoad = function(t) {
                var e = t.target;
                200 === e.status ? this.data = this.xhrType === i.XHR_RESPONSE_TYPE.TEXT ? e.responseText : this.xhrType === i.XHR_RESPONSE_TYPE.DOCUMENT ? e.responseXML || e.response : e.response : this.error = new Error(e.responseText),
                this.complete()
            }
            ,
            i.prototype._determineCrossOrigin = function() {
                if (0 === this.url.indexOf("data:"))
                    return "";
                var t = window.location
                  , e = document.createElement("a");
                return e.href = this.url,
        ...
        14: [function(t, e) {
            ...
            i.prototype.removeChildren = function(t, e) {
                var i = t || 0
                  ...
                  , n = r - i;
                if (n > 0 && r >= n) {
                    for (var o = this.children.splice(i, n), s = 0; s < o.length; ++s)
                        o[s].parent = null;
                    return o
                }
        ...
        15: [function(t, e) {
            ...
            i.prototype.updateTransform = function() {
                var t, e, i, n, o, s, a = this.parent.worldTransform, h = this.worldTransform;
                this.rotation % r.PI_2 ? (this.rotation !== this.rotationCache && (this.rotationCache = this.rotation,
                ...
                o = this.position.x,
                s = this.position.y,
                (this.pivot.x || this.pivot.y) && (o -= this.pivot.x * t + this.pivot.y * i,
                ...
                h.ty = o * a.b + s * a.d + a.ty) : (t = this.scale.x,
                n = this.scale.y,
        ...
        16: [function(t, e) {
            ...
            i.prototype.bezierCurveTo = function(t, e, i, r, n, o) {
                this.currentPath ? 0 === this.currentPath.shape.points.length && (this.currentPath.shape.points = [0, 0]) : this.moveTo(0, 0);
                for (var s, a, h, l, u, c = 20, d = this.currentPath.shape.points, p = d[d.length - 2], f = d[d.length - 1], m = 0, v = 1; c >= v; ++v)
                    m = v / c,
                    s = 1 - m,
                    a = s * s,
                    h = a * s,
                    l = m * m,
                    u = l * m,
                    d.push(h * p + 3 * a * m * t + 3 * s * l * i + u * n, h * f + 3 * a * m * e + 3 * s * l * r + u * o);
                return this.dirty = !0,
                this
            }
            ,
            ...
            i.prototype.arc = function(t, e, i, r, n, o) {
                var s, a = t + Math.cos(r) * i, h = e + Math.sin(r) * i;
                if (this.currentPath ? (s = this.currentPath.shape.points,
                0 === s.length ? s.push(a, h) : (s[s.length - 2] !== a || s[s.length - 1] !== h) && s.push(a, h)) : (this.moveTo(a, h),
            ...
            i.prototype.drawRect = function(t, e, i, r) {
                return this.drawShape(new l.Rectangle(t,e,i,r)),
                this
            }
            ,
            i.prototype.drawRoundedRect = function(t, e, i, r, n) {
                return this.drawShape(new l.RoundedRectangle(t,e,i,r,n)),
                this
            }
            ,
            i.prototype.drawCircle = function(t, e, i) {
                return this.drawShape(new l.Circle(t,e,i)),
                this
            }
            ,
            i.prototype.drawEllipse = function(t, e, i, r) {
                return this.drawShape(new l.Ellipse(t,e,i,r)),
                this
            }
            ,
            ...
            i.prototype.drawShape = function(t) {
                ...
                e.type === u.SHAPES.POLY && (e.shape.closed = this.filling,
                this.currentPath = e),
                this.dirty = !0,
                e
            }
        ...
        18: [function(t, e) {
            ...
            i.prototype.render = function(t) {
                var e, i = this.renderer, n = i.gl, o = i.shaderManager.plugins.primitiveShader;
                ...
                for (var a = 0; a < s.data.length; a++)
                    ...
                    i.stencilManager.popStencil(t, e, i)) : (e = s.data[a],
                    ...
                    n.uniformMatrix3fv(o.uniforms.projectionMatrix._location, !1, i.currentRenderTarget.projectionMatrix.toArray(!0)),
                    ...
                    if (a.type === o.SHAPES.POLY) {
                        ...
                        a.fill && a.points.length >= 6)
                            if (a.points.length < 12) {
                                ...
                                h || (s = this.switchMode(i, 1),
                                this.buildComplexPoly(a, s))
                            } else
                                s = this.switchMode(i, 1),
                                this.buildComplexPoly(a, s);
                        a.lineWidth > 0 && (s = this.switchMode(i, 0),
                        this.buildLine(a, s))
                    } else
                        s = this.switchMode(i, 0),
            ...
            i.prototype.switchMode = function(t, e) {
                ...
                (i.points.length > 32e4 || i.mode !== e || 1 === e) && (i = this.graphicsDataPool.pop() || new h(t.gl),
                i.mode = e,
                t.data.push(i))) : (i = this.graphicsDataPool.pop() || new h(t.gl),
                i.mode = e,
                t.data.push(i)),
                i.dirty = !0,
                i
            ...
            i.prototype.buildCircle = function(t, e) {
                var i, n, s = t.shape, a = s.x, h = s.y;
                t.type === o.SHAPES.CIRC ? (i = s.radius,
                n = s.radius) : (i = s.width,
                n = s.height);
                var l = 40
                  , u = 2 * Math.PI / l
                  , c = 0;
            ...
            i.prototype.buildLine = function(t, e) {
                ...
                if (0 !== o.length) {
                    ...
                    var u, c, d, p, f, m, v, g, y, x, _, b, w, T, S, E, A, C, M, R, P, O, D, F = e.points, L = e.indices, k = o.length / 2, I = o.length, B = F.length / 6, N = t.lineWidth / 2, U = r.hex2rgb(t.lineColor), X = t.lineAlpha, j = U[0] * X, z = U[1] * X, Y = U[2] * X;
                    for (d = o[0],
                    p = o[1],
                    f = o[2],
                    m = o[3],
                    ...
                    i = 1; k - 1 > i; i++)
                        ...
                        F.push(f + y, m + x, j, z, Y, X)) : (u = (E * R - M * A) / P,
                        c = (C * A - S * R) / P,
                        O = (u - f) * (u - f) + (c - m) + (c - m),
                        O > 19600 ? (w = y - _,
                        T = x - b,
                    ...
                    for (var n = 0; n < this.children.length; ++n) {
                        ...
                        if (o.visible) {
                            ...
                            o.rotation % (2 * Math.PI) === 0)
                                ...
                                r = !1),
                                e.drawImage(o.texture.baseTexture.source, s.x, s.y, s.width, s.height, o.anchor.x * -s.width * o.scale.x + o.position.x + .5 | 0, o.anchor.y * -s.height * o.scale.y + o.position.y + .5 | 0, s.width * o.scale.x, s.height * o.scale.y);
                            else {
                                r || (r = !0),
                                o.displayObjectUpdateTransform();
                                var a = o.worldTransform;
                                t.roundPixels ? e.setTransform(a.a, a.b, a.c, a.d, 0 | a.tx, 0 | a.ty) : e.setTransform(a.a, a.b, a.c, a.d, a.tx, a.ty),
                                e.drawImage(o.texture.baseTexture.source, s.x, s.y, s.width, s.height, o.anchor.x * -s.width + .5 | 0, o.anchor.y * -s.height + .5 | 0, s.width, s.height)
                            }
                        }
                    }
                }
        ...
        31: [function(t, e) {
            ...
            i.prototype.render = function(t) {
                ...
                if (0 !== i) {
                    ...
                    a._glTextures[n.id] ? n.bindTexture(n.TEXTURE_2D, a._glTextures[n.id]) : (this.renderer.updateTexture(a),
            ...
            i.prototype.generateBuffers = function(t) {
                var e, i = this.renderer.gl, r = [], n = t._size;
            ...
            i.prototype.uploadVerticies = function(t, e, i, r, n, o) {
                for (var s, a, h, l, u, c, d, p, f, m = 0; i > m; m++)
                    ...
                    p = f + a.crop.height) : (c = a._frame.width * (1 - s.anchor.x),
        ...
        37: [function(t, e) {
            ...
            i.prototype.pushMask = function(t, e) {
                ...
                t.texture || (r.renderGraphicsMask(t, e.context),
                e.context.clip()),
                t.worldAlpha = i
            }
            ,
        ...
        38: [function(t, e) {
            ...
            r.getTintedTexture = function(t, e) {
                ...
                if (r.tintMethod(i, e, o),
                r.convertTintToImage) {
                    var s = new Image;
                    s.src = o.toDataURL(),
                    i.tintCache[n] = s
                } else
            ...
            r.tintWithPerPixel = function(t, e, r) {
                ...
                for (var s = i.hex2rgb(e), a = s[0], h = s[1], l = s[2], u = n.getImageData(0, 0, o.width, o.height), c = u.data, d = 0; d < c.length; d += 4)
                    c[d + 0] *= a,
                    c[d + 1] *= h,
                    c[d + 2] *= l;
        ...
        39: [function(t, e) {
            ...
            i.prototype.updateTexture = function(t) {
                ...
                t.hasLoaded) {
                    ...
                    e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, t.scaleMode === p.SCALE_MODES.LINEAR ? e.LINEAR : e.NEAREST),
                    t.mipmap && t.isPowerOfTwo ? (e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, t.scaleMode === p.SCALE_MODES.LINEAR ? e.LINEAR_MIPMAP_LINEAR : e.NEAREST_MIPMAP_NEAREST),
                    e.generateMipmap(e.TEXTURE_2D)) : e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, t.scaleMode === p.SCALE_MODES.LINEAR ? e.LINEAR : e.NEAREST),
        ...
        40: [function(t, e) {
            ...
            i.prototype.getShader = function(t) {
                var e = t.gl
                  , i = this.shaders[e.id];
                return i || (i = new r(t.shaderManager,this.vertexSrc,this.fragmentSrc,this.uniforms,this.attributes),
                this.shaders[e.id] = i),
                i
            }
            ,
        ...
        46: [function(t, e) {
            ...
            i.prototype.setShader = function(t) {
                return this._currentId === t.uuid ? !1 : (this._currentId = t.uuid,
        ...
        51: [function(t, e) {
            ...
            i.prototype.compile = function() {
                ...
                t.attachShader(r, i),
                t.linkProgram(r),
                t.getProgramParameter(r, t.LINK_STATUS) || (window.console.error("Pixi.js Error: Could not initialize shader."),
                ...
                "" !== t.getProgramInfoLog(r) && window.console.warn("Pixi.js Warning: gl.getProgramInfoLog()", t.getProgramInfoLog(r)),
                t.deleteProgram(r),
                r = null),
                t.deleteShader(e),
                t.deleteShader(i),
            ...
            ,
            i.prototype.syncUniform = function(t) {
                var e, i, n = t._location, o = t.value, s = this.gl;
                switch (t.type) {
                case "i":
                case "1i":
                    s.uniform1i(n, o);
            ...
            i.prototype.initSampler2D = function(t) {
                ...
                if (i.hasLoaded)
                    if (i._glTextures[e.id] = e.createTexture(),
                    ...
                    t.textureData) {
                        ...
                        e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, i.scaleMode === n.SCALE_MODES.LINEAR ? e.LINEAR : e.NEAREST),
                        e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, i.scaleMode === n.SCALE_MODES.LINEAR ? e.LINEAR : e.NEAREST),
                        i.isPowerOfTwo ? (e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, e.REPEAT),
                        e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, e.REPEAT)) : (e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE),
                        e.texParameteri(e.TEXTURE_2D, e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE))
            }
            ,
            ...
            i.prototype._glCompile = function(t, e) {
                ...
                this.gl.getShaderParameter(i, this.gl.COMPILE_STATUS) ? i : (window.console.log(this.gl.getShaderInfoLog(i)),
                null)
            }
        }
        , {
            ...
            var i = t("../../../math")
              ...
              , s = function(t, e, s, a, h, l) {
                ...
                !this.root) {
                    ...
                    t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, a === n.SCALE_MODES.LINEAR ? t.LINEAR : t.NEAREST),
                    t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, a === n.SCALE_MODES.LINEAR ? t.LINEAR : t.NEAREST);
        ...
        57: [function(t, e) {
            ...
            Object.defineProperties(i.prototype, {
                ...
                texture: {
                    ...
                    set: function(t) {
                        ...
                        this.cachedTint = 16777215,
                        t && (t.baseTexture.hasLoaded ? this._onTextureUpdate() : t.once("update", this._onTextureUpdate.bind(this))))
                    }
                }
            }),
            ...
            i.prototype.getBounds = function(t) {
                if (!this._currentBounds) {
                    var e, i, r, n, o = this._texture._frame.width, s = this._texture._frame.height, a = o * (1 - this.anchor.x), h = o * -this.anchor.x, l = s * (1 - this.anchor.y), u = s * -this.anchor.y, c = t || this.worldTransform, d = c.a, p = c.b, f = c.c, m = c.d, v = c.tx, g = c.ty;
                    if (0 === p && 0 === f)
                        0 > d && (d *= -1),
                        0 > m && (m *= -1),
                        e = d * h + v,
            ...
            i.prototype.renderCanvas = function(t) {
                if (!(!this.visible || this.alpha <= 0 || this.texture.crop.width <= 0 || this.texture.crop.height <= 0) && this.renderable) {
                    ...
                    this.texture.valid) {
                        ...
                        t.smoothProperty && t.currentScaleMode !== this.texture.baseTexture.scaleMode && (t.currentScaleMode = this.texture.baseTexture.scaleMode,
        ...
        58: [function(t, e) {
            ...
            i.prototype.render = function(t) {
                ...
                if (i) {
                    ...
                    var u = this.currentBatchSize * this.vertByteSize
                      ...
                      , y = this.colors
                      , x = this.positions;
                    this.renderer.roundPixels ? (x[u] = d * n + f * s + v | 0,
                    x[u + 1] = m * s + p * n + g | 0,
                    x[u + 5] = d * r + f * s + v | 0,
                    x[u + 6] = m * s + p * r + g | 0,
                    x[u + 10] = d * r + f * o + v | 0,
                    x[u + 11] = m * o + p * r + g | 0,
                    x[u + 15] = d * n + f * o + v | 0,
                    x[u + 16] = m * o + p * n + g | 0) : (x[u] = d * n + f * s + v,
                    x[u + 1] = m * s + p * n + g,
                    x[u + 5] = d * r + f * s + v,
                    x[u + 6] = m * s + p * r + g,
                    x[u + 10] = d * r + f * o + v,
            ...
            i.prototype.flush = function() {
                if (0 !== this.currentBatchSize) {
                    ...
                    for (var r, o, s, a, h = 0, l = 0, u = null, c = this.renderer.blendModeManager.currentBlendMode, d = null, p = !1, f = !1, m = 0, v = this.currentBatchSize; v > m; m++)
                        a = this.sprites[m],
                        ...
                        p = c !== o,
                        f = d !== s,
                        (u !== r || p || f) && (this.renderBatch(u, h, l),
                        l = m,
                        h = 0,
                        u = r,
                        p && (c = o,
                        ...
                        t || (t = new n(this.renderer.shaderManager,null,d.fragmentSrc,d.uniforms),
                        d.shaders[e.id] = t),
                        this.renderer.shaderManager.setShader(t),
                        e.uniformMatrix3fv(t.uniforms.projectionMatrix._location, !1, this.renderer.currentRenderTarget.projectionMatrix.toArray(!0)))),
                        h++;
        ...
        59: [function(t, e) {
            ...
            ,
            i.prototype.destroy = function() {
                this.imageUrl ? (delete r.BaseTextureCache[this.imageUrl],
                delete r.TextureCache[this.imageUrl],
                this.imageUrl = null,
                navigator.isCocoonJS || (this.source.src = "")) : this.source && this.source._pixiId && delete r.BaseTextureCache[this.source._pixiId],
                this.source = null,
                this.dispose()
            }
            ,
            ...
            i.fromCanvas = function(t, e) {
                ...
                return n || (n = new i(t,e),
                r.BaseTextureCache[t._pixiId] = n),
                n
            }
        }
        , {
        ...
        60: [function(t, e) {
            ...
            i.prototype.resize = function(t, e, i) {
                ...
                this.renderer.type === h.RENDERER_TYPE.WEBGL && (this.projection.x = this.width / 2,
        ...
        61: [function(t, e) {
            function i(t, e, r, n, o) {
                ...
                this.frame = e) : t.addEventListener("loaded", this.onBaseTextureLoaded.bind(this))
            }
            var r = t("./BaseTexture")
            ...
            i.fromImage = function(t, e, n) {
                ...
                return o || (o = new i(r.fromImage(t, e, n)),
                h.TextureCache[t] = o),
                o
            }
            ,
        ...
        63: [function(t, e) {
            ...
            ,
            i.prototype.destroy = function() {
                this.source && this.source._pixiId && (o.BaseTextureCache[this.source._pixiId] = null,
        ...
        66: [function(t, e) {
            var i = t("./eventTarget")
              ...
              , n = function() {
                ...
                this.active = !1,
                this.eventData = new r(this,"tick",{
                    deltaTime: 1
                }),
                this.deltaTime = 1,
                this.timeElapsed = 0,
        ...
        67: [function(t, e) {
            function i(t) {
                ...
                t.emit = t.dispatchEvent = function(t, e) {
                    ...
                    this._listeners[t]) {
                        e && e.__isEventObject || (n.target = this,
                        n.type = t,
                        n.data = e,
                        e = n);
                        var i, r = this._listeners[t].slice(0), o = r.length, s = r[0];
                        for (i = 0; o > i; s = r[++i])
                            if (s(e),
                            e.stoppedImmediate)
                                return this;
                ...
                t.off = t.removeEventListener = function(t, e) {
                    ...
                    return 0 === i.length && (this._listeners[t] = null),
                    this
                }
                ,
                t.removeAllListeners = function(t) {
                    return this._listeners = this._listeners || {},
                    this._listeners[t] ? (this._listeners[t] = null,
                    this) : this
                }
            }
            var r = t("./EventData")
                ...
                sayHello: function(t) {
                    if (!r._saidHello) {
                        if (navigator.userAgent.toLowerCase().indexOf("chrome") > -1) {
                            var e = ["%c %c %c Pixi.js " + i.VERSION + " - " + t + "  %c  %c  http://www.pixijs.com/  %c %c â™¥%câ™¥%câ™¥ ", "background: #ff66a5", "background: #ff66a5", "color: #ff66a5; background: #030307;", "background: #ff66a5", "background: #ffc3dc", "background: #ff66a5", "color: #ff2424; background: #fff", "color: #ff2424; background: #fff", "color: #ff2424; background: #fff"];
        ...
        70: [function(t, e) {
            ...
            i.prototype.play = function() {
                ...
                n.Ticker.on("tick", this._updateBound))
            }
            ,
            ...
            i.prototype.update = function(t) {
                ...
                0 > e ? this.loop ? (this.currentFrame += this._textures.length,
                this.texture = this._textures[this.currentFrame]) : (this.gotoAndStop(0),
                this.onComplete && this.onComplete()) : this.loop || e < this._textures.length ? this.texture = this._textures[e % this._textures.length] : e >= this._textures.length && (this.gotoAndStop(this.textures.length - 1),
        ...
        72: [function(t, e) {
            ...
            e.exports = i,
            i.prototype.renderWebGL = function(t) {
                !this.visible || this.alpha <= 0 || !this.renderable || (t.spriteBatch.stop(),
            ...
            i.prototype._renderStrip = function(t) {
                ...
                this.texture.baseTexture._dirty[e.id] ? t.updateTexture(this.texture.baseTexture) : e.bindTexture(e.TEXTURE_2D, this.texture.baseTexture._glTextures[e.id]),
                e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, this._indexBuffer),
            ...
            i.prototype.renderCanvas = function(t) {
                if (this.visible && !(this.alpha <= 0) && this.renderable) {
                    ...
                    this.drawMode === i.DrawModes.TRIANGLE_STRIP ? this._renderCanvasTriangleStrip(e) : this._renderCanvasTriangles(e)
                }
            }
            ,
        ...
        74: [function(t, e) {
            ...
            i.prototype.renderCanvas = function(t) {
                if (this.visible && !(this.alpha <= 0)) {
                    ...
                    this._mask && t.maskManager.pushMask(this._mask, t),
                    e.globalAlpha = this.worldAlpha;
                    var i, r, n = this.worldTransform, o = t.resolution;
                    if (e.setTransform(n.a * o, n.b * o, n.c * o, n.d * o, n.tx * o, n.ty * o),
                    ...
                    this._mask && t.maskManager.popMask(t),
                    i = 0,
                    r = this.children.length; r > i; ++i)
                        this.children[i].renderCanvas(t)
                }
            }
            ,
            i.prototype.getBounds = function() {
                var t, e, i, r, n = this._width, o = this._height, s = n * (1 - this.anchor.x), a = n * -this.anchor.x, h = o * (1 - this.anchor.y), l = o * -this.anchor.y, u = this.worldTransform, c = u.a, d = u.b, p = u.c, f = u.d, m = u.tx, v = u.ty, g = c * a + p * l + m, y = f * l + d * a + v, x = c * s + p * l + m, _ = f * l + d * s + v, b = c * s + p * h + m, w = f * h + d * s + v, T = c * a + p * h + m, S = f * h + d * a + v;
                t = g,
                t = t > x ? x : t,
                t = t > b ? b : t,
                t = t > T ? T : t,
            ...
            i.prototype.generateTilingTexture = function(t, e, i) {
                if (this.texture.baseTexture.hasLoaded) {
                    ...
                    var n, a, h = e.frame, l = h.width !== e.baseTexture.width || h.height !== e.baseTexture.height;
            ...
            i.prototype.hitTest = function(t) {
                ...
                return a.x > n && a.x < n + i && (e = -r * this.anchor.y,
                a.y > e && a.y < e + r) ? !0 : !1
            }
            ,
            i.prototype.destroy = function() {
            ...
            Object.defineProperties(n.prototype, {
                cacheAsBitmap: {
                    ...
                    set: function(t) {
                        ...
                        this.renderCanvas = this._renderCachedCanvas) : (this._cachedSprite && this._destroyCachedDisplayObject(),
        ...
        93: [function(t, e) {
            function i(t) {
                ...
                t.baseTexture.hasLoaded ? this.onTextureLoaded() : t.baseTexture.once("loaded", this.onTextureLoaded.bind(this))
            }
            var r = t("../../core");
            i.prototype = Object.create(r.AbstractFilter.prototype),
            i.prototype.constructor = i,
        ...
        104: [function(t, e) {
            ...
            i.prototype.addEvents = function() {
                this.interactionDOMElement && (window.navigator.msPointerEnabled && (this.interactionDOMElement.style["-ms-content-zooming"] = "none",
            ...
            i.prototype.removeEvents = function() {
                this.interactionDOMElement && (window.navigator.msPointerEnabled && (this.interactionDOMElement.style["-ms-content-zooming"] = "",
            ...
            ,
            i.prototype.update = function() {
                if (requestAnimationFrame(this.update.bind(this)),
                !this.throttleUpdate() && this.interactionDOMElement) {
                    if (this.didMove)
                        return void (this.didMove = !1);
                    this.cursor = "inherit",
                    this.processInteractive(this.mouse.global, this.renderer._lastObjectRendered, this.processMouseOverOut.bind(this), !0),
            ...
            i.prototype.processInteractive = function(t, e, i, r, n) {
                ...
                e.interactiveChildren)
                    for (var a = o.length - 1; a >= 0; a--)
                        !s && r ? s = this.processInteractive(t, o[a], i, !0, n) : this.processInteractive(t, o[a], i, !1, !1);
                return n && (r && (e.hitArea ? (e.worldTransform.applyInverse(t, this._tempPoint),
                s = e.hitArea.contains(this._tempPoint.x, this._tempPoint.y)) : e.hitTest && (s = e.hitTest(t))),
                e.interactive && i(e, s)),
                s
            }
            ,
        ...
        106: [function(t, e) {
            ...
            i.Sprite.prototype.hitTest = function(t) {
                ...
                var e, i = this._texture._frame.width, n = this._texture._frame.height, o = -i * this.anchor.x;
                return r.x > o && r.x < o + i && (e = -n * this.anchor.y,
                r.y > e && r.y < e + n) ? !0 : !1
            }
            ,
        ...
        107: [function(t, e) {
            var i = t("resource-loader")
              ...
              , a = function() {
                i.call(this),
                this.use(i.middleware.parsing.json()).use(i.middleware.parsing.blob()).use(r()).use(n()).use(o()).use(s())
            };
                ...
                return function(t, e) {
                    if (!t.data || navigator.isCocoonJS)
                        if (window.DOMParser) {
                            ...
                            o.innerHTML = this.xhr.responseText,
                            t.data = o
                        }
                    var s = t.data.nodeName;
                    if (!t.data || !s || "#document" !== s.toLowerCase() || "div" !== s.toLowerCase())
                        return e();
                        ...
                        this.add(t.name + "_image", this.baseUrl + s + "/" + t.data.meta.image, o, function(i) {
                            ...
                            for (var o in r) {
                                ...
                                if (s) {
                                    var h = null
                                      , l = null;
                                    if (h = r[o].rotated ? new n.math.Rectangle(s.x,s.y,s.h,s.w) : new n.math.Rectangle(s.x,s.y,s.w,s.h),
                                    r[o].trimmed && (l = new n.math.Rectangle(r[o].spriteSourceSize.x / a,r[o].spriteSourceSize.y / a,r[o].sourceSize.w / a,r[o].sourceSize.h / a)),
                                    r[o].rotated) {
                                        var u = h.width;
                                        h.width = h.height,
                                        h.height = u
        ...
        112: [function(t, e) {
            ...
            e.exports = function() {
                return function(t, e) {
                    t.data && t.data.nodeName && "img" === t.data.nodeName.toLowerCase() && (t.texture = new i.Texture(new i.BaseTexture(t.data,null,i.utils.getResolutionOfUrl(t.url))),
        ...
        113: [function(t, e) {
            function i(t) {
                ...
                for (var e = 0, i = this.skeleton.drawOrder.length; i > e; e++) {
                    ...
                    s instanceof n.RegionAttachment) {
                        ...
                        if (!(s instanceof n.MeshAttachment))
                            continue;
                    ...
                    if (a) {
                        ...
                        if (l === n.AttachmentType.region) {
                            if (a.rendererObject && (!s.currentSpriteName || s.currentSpriteName !== a.rendererObject.name)) {
                                ...
                                if (void 0 !== s.currentSprite && (s.currentSprite.visible = !1),
                                s.sprites = s.sprites || {},
                                void 0 !== s.sprites[u])
                            ...
                            if (!s.currentMeshName || s.currentMeshName !== a.name) {
                                var p = a.name;
                                if (void 0 !== s.currentMesh && (s.currentMesh.visible = !1),
                                s.meshes = s.meshes || {},
                                void 0 !== s.meshes[p])
            ...
            i.prototype.createSprite = function(t, e) {
                ...
                return h.scale.set(i.width / i.originalWidth, i.height / i.originalHeight),
            ...
            i.prototype.createMesh = function(t, e) {
                var i = e.rendererObject
                  ...
                  , o = new r.Texture(n)
                  , s = new r.Strip(o);
                return s.drawMode = r.Strip.DrawModes.TRIANGLES,
                s.canvasPadding = 1.5,
        ...
        114: [function(t, e) {
            ...
            r.Bone.prototype = {
                ...
                updateWorldTransform: function() {
                    ...
                    var n = this.worldRotation * r.degRad
                      , o = Math.cos(n)
                      , s = Math.sin(n);
                    this.worldFlipX ? (this.m00 = -o * this.worldScaleX,
                    this.m01 = s * this.worldScaleY) : (this.m00 = o * this.worldScaleX,
                    this.m01 = -s * this.worldScaleY),
                    this.worldFlipY != r.Bone.yDown ? (this.m10 = -s * this.worldScaleX,
                    this.m11 = -o * this.worldScaleY) : (this.m10 = s * this.worldScaleX,
                ...
                worldToLocal: function(t) {
                    var e = t[0] - this.worldX
                      ...
                      , s = this.m01
                      , a = this.m11;
                    this.worldFlipX != (this.worldFlipY != r.Bone.yDown) && (n = -n,
                    a = -a);
                    var h = 1 / (n * a - s * o);
                    t[0] = e * n * h - i * s * h,
                    t[1] = i * a * h - e * o * h
            ...
            r.IkConstraint.apply2 = function(t, e, i, n, o, s) {
                var a = e.rotation
                  , h = t.rotation;
                if (!s)
                    return e.rotationIK = a,
                    void (t.rotationIK = h);
                var l, u, c = r.temp, d = t.parent;
                d ? (c[0] = i,
                c[1] = n,
                d.worldToLocal(c),
                i = (c[0] - t.x) * d.worldScaleX,
                n = (c[1] - t.y) * d.worldScaleY) : (i -= t.x,
                n -= t.y),
                e.parent == t ? (l = e.x,
                u = e.y) : (c[0] = e.x,
                c[1] = e.y,
                ...
                var p = l * t.worldScaleX
                  ...
                  , y = 2 * v * g;
                if (1e-4 > y)
                    return void (e.rotationIK = a + (Math.atan2(n, i) * r.radDeg - h - a) * s);
            ...
            r.Animation.prototype = {
                apply: function(t, e, i, r, n) {
                    r && 0 != this.duration && (i %= this.duration,
                    e %= this.duration);
            ...
            r.RotateTimeline.prototype = {
                ...
                apply: function(t, e, i, n, o) {
                    ...
                    if (!(i < s[0])) {
                        ...
                        if (i >= s[s.length - 2]) {
                            for (var h = a.data.rotation + s[s.length - 1] - a.rotation; h > 180; )
                                h -= 360;
                            for (; -180 > h; )
                                h += 360;
                        ...
                        for (var h = s[l + 1] - u; h > 180; )
                            h -= 360;
                        for (; -180 > h; )
                            h += 360;
                        for (h = a.data.rotation + (u + h * d) - a.rotation; h > 180; )
                            h -= 360;
                        for (; -180 > h; )
                            h += 360;
                        a.rotation += h * o
            ...
            r.TranslateTimeline.prototype = {
                ...
                apply: function(t, e, i, n, o) {
                    ...
                    if (!(i < s[0])) {
                        var a = t.bones[this.boneIndex];
                        if (i >= s[s.length - 3])
                            return a.x += (a.data.x + s[s.length - 2] - a.x) * o,
            ...
            r.ScaleTimeline.prototype = {
                ...
                apply: function(t, e, i, n, o) {
                    ...
                    if (!(i < s[0])) {
                        var a = t.bones[this.boneIndex];
                        if (i >= s[s.length - 3])
                            return a.scaleX += (a.data.scaleX * s[s.length - 2] - a.scaleX) * o,
            ...
            r.AttachmentTimeline.prototype = {
                ...
                apply: function(t, e, i) {
                    var n = this.frames;
                    if (i < n[0])
                        return void (e > i && this.apply(t, e, Number.MAX_VALUE, null, 0));
                    e > i && (e = -1);
                ...
                apply: function(t, e, i, n, o) {
                    if (n) {
                        var s = this.frames
                          , a = s.length;
                        if (e > i)
                            this.apply(t, e, Number.MAX_VALUE, n, o),
                            e = -1;
                        else if (e >= s[a - 1])
                            return;
                        if (!(i < s[0])) {
            ...
            r.IkConstraintTimeline.prototype = {
                ...
                apply: function(t, e, i, n, o) {
                    ...
                    if (!(i < s[0])) {
                        ...
                        if (i >= s[s.length - 3])
                            return a.mix += (s[s.length - 2] - a.mix) * o,
            ...
            r.Skeleton.prototype = {
                ...
                updateWorldTransform: function() {
                    ...
                    for (var e = 0, n = this.boneCache.length - 1; ; ) {
                        for (var o = this.boneCache[e], s = 0, a = o.length; a > s; s++)
                ...
                setAttachment: function(t, e) {
                    for (var i = this.slots, r = 0, n = i.length; n > r; r++) {
                        ...
                        if (o.data.name == t) {
                            var s = null;
                            if (e && (s = this.getAttachmentBySlotIndex(r, e),
                            !s))
            ...
            r.MeshAttachment.prototype = {
                ...
                updateUVs: function() {
                    ...
                    if (this.uvs && this.uvs.length == i || (this.uvs = new r.Float32Array(i)),
                    this.regionRotate)
                        for (var n = 0; i > n; n += 2)
            ...
            r.SkinnedMeshAttachment.prototype = {
                ...
                computeWorldVertices: function(t, e, i, r) {
                    var n, o, s, a, h, l, u, c = i.bone.skeleton.bones, d = this.weights, p = this.bones, f = 0, m = 0, v = 0, g = 0, y = p.length;
            ...
            r.AnimationState.prototype = {
                ...
                update: function(t) {
                    ...
                    for (var e = 0; e < this.tracks.length; e++) {
                        ...
                        if (i) {
                            ...
                            var n = i.next;
                            n ? (n.time = i.lastTime - n.delay,
                            n.time >= 0 && this.setCurrent(e, n)) : !i.loop && i.lastTime >= i.endTime && this.clearTrack(e)
                        }
                    }
                },
                apply: function(t) {
                    for (var e = 0; e < this.tracks.length; e++) {
                        ...
                        if (i) {
                            ...
                            if (a) {
                                ...
                                1 == i.mix ? i.animation.apply(t, i.lastTime, r, s, this.events) : i.animation.mix(t, i.lastTime, r, s, this.events, i.mix);
                ...
                setCurrent: function(t, e) {
                    ...
                    if (i) {
                        ...
                        e.previous = r && i.mixTime / i.mixDuration < .5 ? r : i)
                    }
                    this.tracks[t] = e,
                ...
                addAnimation: function(t, e, i, n) {
                    ...
                    if (s) {
                        ...
                        this.tracks[t] = o;
                    return 0 >= n && (s ? n += s.endTime - this.data.getMix(s.animation, e) : n = 0),
                    o.delay = n,
                    o
                },
            ...
            r.SkeletonJsonParser.prototype = {
                ...
                readSkeletonData: function(t, e) {
                    ...
                    for (var o = t.bones, s = 0, a = o.length; a > s; s++) {
                        var h = o[s]
                          , l = null;
                        if (h.parent && (l = i.findBone(h.parent),
                        !l))
                    ...
                    if (c)
                        for (var s = 0, a = c.length; a > s; s++) {
                            for (var d = c[s], p = new r.IkConstraintData(d.name), o = d.bones, f = 0, m = o.length; m > f; f++) {
                                ...
                                if (!v)
                                    throw "IK bone not found: " + o[f];
                                p.bones.push(v)
                            }
                            if (p.target = i.findBone(d.target),
                            !p.target)
                    ...
                    for (var g = t.slots, s = 0, a = g.length; a > s; s++) {
                        var y = g[s]
                          , u = i.findBone(y.bone);
                        if (!u)
                            throw "Slot bone not found: " + y.bone;
                        var x = new r.SlotData(y.name,u)
                          , _ = y.color;
                        _ && (x.r = this.toColor(_, 0),
                ...
                readAttachment: function(t, e, i) {
                    ...
                    if (n == r.AttachmentType.boundingbox) {
                        for (var y = this.attachmentLoader.newBoundingBoxAttachment(t, e), c = i.vertices, f = 0, m = c.length; m > f; f++)
                            ...
                            for (var u in h)
                                if (h.hasOwnProperty(u)) {
                                    ...
                                    if ("color" == u) {
                                        ...
                                        n.push(d),
                                        o = Math.max(o, d.frames[5 * d.getFrameCount() - 5])
                                    } else {
                                        if ("attachment" != u)
                                            throw "Invalid timeline type for a slot: " + u + " (" + a + ")";
                            ...
                            for (var u in E)
                                if (E.hasOwnProperty(u)) {
                                    ...
                                    if ("rotate" == u) {
                                        ...
                                        n.push(d),
                                        o = Math.max(o, d.frames[2 * d.getFrameCount() - 2])
                                    } else if ("translate" == u || "scale" == u) {
                                        var d, A = 1;
                                        "scale" == u ? d = new r.ScaleTimeline(c.length) : (d = new r.TranslateTimeline(c.length),
                                        A = this.scale),
                                        d.boneIndex = S;
                                        for (var p = 0, f = 0, m = c.length; m > f; f++) {
                                            var v = c[f]
                                        ...
                                        n.push(d),
                                        o = Math.max(o, d.frames[3 * d.getFrameCount() - 3])
                                    } else {
                                        if ("flipX" != u && "flipY" != u)
                            ...
                            for (var U in N) {
                                ...
                                for (var p = 0, f = 0, m = c.length; m > f; f++) {
                                    ...
                                    if (v.vertices) {
                                        ...
                                        if (z)
                                            for (var q = X.vertices, V = 0, H = Y.length; H > V; V++)
                                                Y[V] += q[V]
                                    } else
                                        z ? Y = X.vertices : (Y = [],
                                        Y.length = j);
                ...
                getIntArray: function(t, e) {
                    for (var i = t[e], n = new r.Uint16Array(i.length), o = 0, s = i.length; s > o; o++)
                        n[o] = 0 | i[o];
                    return n
                }
            },
                ...
                for (var a = null; ; ) {
                    ...
                    h.length)
                        if (a) {
                            ...
                            l.u = u / a.width,
                            l.v = c / a.height,
                            l.rotate ? (l.u2 = (u + p) / a.width,
                            l.v2 = (c + d) / a.height) : (l.u2 = (u + d) / a.width,
                            l.v2 = (c + p) / a.height),
                            l.x = u,
                            l.y = c,
                            l.width = Math.abs(d),
                            l.height = Math.abs(p),
                            4 == o.readTuple(s) && (l.splits = [parseInt(s[0]), parseInt(s[1]), parseInt(s[2]), parseInt(s[3])],
                            4 == o.readTuple(s) && (l.pads = [parseInt(s[0]), parseInt(s[1]), parseInt(s[2]), parseInt(s[3])],
                            o.readTuple(s))),
                            ...
                            a = new r.AtlasPage,
                            a.name = h,
                            2 == o.readTuple(s) && (a.width = parseInt(s[0]),
                            ...
                            "x" == f ? a.uWrap = r.Atlas.TextureWrap.repeat : "y" == f ? a.vWrap = r.Atlas.TextureWrap.repeat : "xy" == f && (a.uWrap = a.vWrap = r.Atlas.TextureWrap.repeat),
            ...
            r.Atlas.prototype = {
                ...
                updateUVs: function(t) {
                    for (var e = this.regions, i = 0, r = e.length; r > i; i++) {
                        var n = e[i];
                        n.page == t && (n.u = n.x / t.width,
                        n.v = n.y / t.height,
                        n.rotate ? (n.u2 = (n.x + n.height) / t.width,
                        n.v2 = (n.y + n.width) / t.height) : (n.u2 = (n.x + n.width) / t.width,
            ...
            r.AtlasReader.prototype = {
                ...
                readTuple: function(t) {
                    ...
                    for (var r = 0, n = i + 1; 3 > r; r++) {
                        ...
                        if (-1 == o)
                            break;
                        t[r] = this.trim(e.substr(n, o - n)),
                        n = o + 1
                    }
                    return t[r] = this.trim(e.substring(n)),
                    r + 1
                }
            },
            ...
            r.AtlasAttachmentParser.prototype = {
                newRegionAttachment: function(t, e, i) {
                    ...
                    if (!n)
                        throw "Region not found in atlas: " + i + " (region attachment: " + e + ")";
                    var o = new r.RegionAttachment(e);
                    return o.rendererObject = n,
                ...
                newMeshAttachment: function(t, e, i) {
                    var n = this.atlas.findRegion(i);
                    if (!n)
                        throw "Region not found in atlas: " + i + " (mesh attachment: " + e + ")";
                ...
                newSkinnedMeshAttachment: function(t, e, i) {
                    var n = this.atlas.findRegion(i);
                    if (!n)
                        throw "Region not found in atlas: " + i + " (skinned mesh attachment: " + e + ")";
            ...
            r.SkeletonBounds.prototype = {
                ...
                aabbIntersectsSegment: function(t, e, i, r) {
                    var n = this.minX
                      ...
                      , s = this.maxX
                      , a = this.maxY;
                    if (n >= t && n >= i || o >= e && o >= r || t >= s && i >= s || e >= a && r >= a)
                        return !1;
                    var h = (r - e) / (i - t)
                      , l = h * (n - t) + e;
                    if (l > o && a > l)
        ...
        116: [function(t, e) {
            ...
            Object.defineProperties(i.prototype, {
                tint: {
                    ...
                    set: function(t) {
                        this._style.tint = "number" == typeof t && t >= 0 ? t : 16777215,
                        this.dirty = !0
                    }
                },
                align: {
                ...
                font: {
                    ...
                    set: function(t) {
                        ...
                        this._style.fontSize = t.length >= 2 ? parseInt(t[0], 10) : i.fonts[this.fontName].size) : (this._style.fontName = t.name,
            ...
            i.prototype.updateText = function() {
                for (var t = i.fonts[this.fontName], e = new r.math.Point, n = null, o = [], s = 0, a = 0, h = [], l = 0, u = this.fontSize / t.size, c = -1, d = 0; d < this.text.length; d++) {
                    ...
                    /(?:\r\n|\r|\n)/.test(this.text.charAt(d)))
                        ...
                        var f = t.chars[p];
                        f && (n && f.kerning[n] && (e.x += f.kerning[n]),
                        o.push({
                            texture: f.texture,
                            line: l,
                            charCode: p,
                ...
                for (d = 0; g > d; d++) {
                    ...
                    x ? x.texture = o[d].texture : (x = new r.Sprite(o[d].texture),
                    this._glyphs.push(x)),
        ...
        117: [function(t, e) {
            ...
            i.prototype.determineFontProperties = function(t) {
                ...
                if (!e) {
                    ...
                    n.fillStyle = "#000",
                    n.fillText("|Mï¿½q", 0, s);
                    var h, l, u = n.getImageData(0, 0, o, a).data, c = u.length, d = 4 * o, p = 0, f = !1;
                    for (h = 0; s > h; h++) {
                        for (l = 0; d > l; l += 4)
                            if (255 !== u[p + l]) {
                                f = !0;
...
function(t) {
    ...
    r.prototype = {
        ...
        add: function(t, e, r) {
            return i(t, "add"),
            this._registerListener(t, !1, e, r)
        },
        addOnce: function(t, e, r) {
            return i(t, "addOnce"),
            this._registerListener(t, !0, e, r)
        },
        remove: function(t, e) {
            i(t, "remove");
            var r = this._indexOfListener(t, e);
            return -1 !== r && (this._bindings[r]._destroy(),
...
define("com/fido/loader/Loader", ["require", "exports", "module", "PIXI", "signals", "com/fido/loader/Cache"], function(t, e, i) {
    var r = t("PIXI")
      ...
      , s = function() {
        this.crossdomain = !1,
        window.XDomainRequest && this.crossdomain ? (this.ajaxRequest = new window.XDomainRequest,
    ...
    s.prototype._loadFiles = function() {
        this.fileCount = 0,
        this.filesToLoad.length ? this._loadNextFile() : this._loadPixiAssets()
    }
    ,
    s.prototype._loadNextFile = function() {
        var t = this.filesToLoad[this.fileCount];
        t.type === s.CUSTOM ? (t.object.onLoaded.addOnce(this._onFileLoaded, this),
        t.object.load()) : (this.ajaxRequest.open("GET", t.url, !0),
    ...
    s.prototype._loadPixiAssets = function() {
        return 0 === this.pixiAssetsToLoad.length ? void this._onComplete() : (this.pixiAssetLoader = new r.loaders.Loader,
        this.pixiAssetLoader.addList(this.pixiAssetsToLoad),
        void this.pixiAssetLoader.load(function() {
            this._onProgress(),
            this._onComplete()
        }
        .bind(this)))
    ...
    s.prototype._onProgress = function() {
        var t = (this.filesToLoad.length + this.pixiAssetsToLoad.length,
        this.fileCount);
...
define("com/fido/app/transitions/AlphaTransition", ["require", "exports", "module"], function(t, e, i) {
    ...
    AlphaTransition.prototype.begin = function(t, e, i) {
        ...
        this.nextScreen = i,
        this.currentScreen ? (this.currentScreen.onHide && this.currentScreen.onHide(),
    ...
    AlphaTransition.prototype.onFadeout = function() {
        this.currentScreen && (this.currentScreen.onHidden && this.currentScreen.onHidden(),
        ...
        TweenLite.to(this.nextScreen, .4, {
            alpha: 1,
...
define("com/fido/app/ScreenManager", ["require", "exports", "module", "PIXI", "./transitions/AlphaTransition"], function(t, e, i) {
    ...
    o.prototype.gotoScreen = function(t) {
        if (this.currentScreen !== t && (this.history.push(t),
        this.nextScreen = t,
        !this.active)) {
            this.active = !0,
...
define("com/fido/system/Device", ["require", "exports", "module"], function(t, e, i) {
    ...
    Device.prototype._checkBrowser = function(t) {
        /Arora/.test(t) ? this.arora = !0 : /Chrome/.test(t) ? this.chrome = !0 : /Epiphany/.test(t) ? this.epiphany = !0 : /Firefox/.test(t) ? this.firefox = !0 : /Mobile Safari/.test(t) ? this.mobileSafari = !0 : /MSIE (\d+\.\d+);/.test(t) || navigator.userAgent.match(/Trident.*rv[ :]*11\./) ? (this.ie = !0,
        this.ieVersion = parseInt(RegExp.$1, 10)) : /Midori/.test(t) ? this.midori = !0 : /Opera/.test(t) ? this.opera = !0 : /Safari/.test(t) && (this.safari = !0),
        navigator.standalone && (this.webApp = !0),
        navigator.isCocoonJS && (this.cocoonJS = !0)
    }
    ,
    Device.prototype._checkOS = function(t) {
        /Android/.test(t) ? this.android = !0 : /CrOS/.test(t) ? this.chromeOS = !0 : /iP[ao]d|iPhone/i.test(t) ? (this.iOS = !0,
        this.iOS_version = parseFloat(("" + (/CPU.*OS ([0-9_]{1,5})|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent) || [0, ""])[1]).replace("undefined", "3_2").replace("_", ".").replace("_", "")) || !1) : /Linux/.test(t) ? this.linux = !0 : /Mac OS/.test(t) ? this.macOS = !0 : /Windows/.test(t) && (this.windows = !0),
    ...
    Device.prototype._checkAudio = function() {
        ...
        var t = document.createElement("audio")
          , e = !1;
        try {
            (e = !!t.canPlayType) && (t.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, "") && (this.ogg = !0),
...
define("com/fido/utils/FrameWait", ["require", "exports", "module"], function(t, e, i) {
    ...
    r.prototype.update = function() {
        for (var t = this.waits.length - 1; t >= 0; t--) {
            var e = this.waits[t];
            e.count--,
            e.count <= 0 && (e.callback(),
            this.waits.splice(t, 1))
        }
...
define("com/fido/app/LoaderScreen", ["require", "exports", "module", "PIXI", "com/fido/system/Ticker", "com/fido/utils/FrameWait", "signals"], function(t, e, i) {
    ...
    a.prototype.update = function() {
        ...
        this.easeLoad > .99 && (this.easeLoad = 1,
    ...
    a.prototype.resize = function(t, e) {
        this.w = t,
        this.h = e,
        this.barBg && (this.barBg.scale.x = t / 100,
        this.barBg.y = e / 2 - 50)
    }
    ,
    i.exports = a
...
define("com/fido/app/OrientationManager", ["require", "exports", "module", "com/fido/system/Ticker"], function(t, e, i) {
    var r = t("com/fido/system/Ticker")
      , n = function(t) {
        ...
        this.supportsOrientationChange && window.addEventListener("orientationchange", this.checkOrientation.bind(this), !1)
    };
    n.constructor = n,
    n.prototype.checkOrientation = function() {
        90 === window.orientation || -90 === window.orientation ? (r.instance.stop(),
        this.rotateScreen.style.display = "block") : (r.instance.start(),
        this.rotateScreen.style.display = "none")
    }
    ,
    n.prototype.check = function(t, e) {
        ...
        this.supportsOrientationChange || (i ? (r.instance.stop(),
        this.rotateScreen.style.display = "block") : (r.instance.start(),
        this.rotateScreen.style.display = "none"))
    }
    ,
...
define("com/fido/app/App", ["require", "exports", "module", "PIXI", "com/fido/loader/Loader", "com/fido/app/ScreenManager", "com/fido/system/Ticker", "com/fido/system/Device", "com/fido/app/LoaderScreen", "com/fido/app/OrientationManager", "signals"], function(t, e, i) {
    var r = t("PIXI")
      ...
      , c = function(t) {
        ...
        this.loader = new n,
        this.onReady = new u,
        this.options.orientationMode !== c.orientationModes.BOTH && (this.orientationManager = new l(this.options.orientationMode)),
    ...
    c.prototype.setupPixi = function() {
        ...
        ,
        t.forceCanvas || a.instance.android && !a.instance.chrome ? (this.renderer = new r.CanvasRenderer(t.width,t.height),
        this.renderer.clearBeforeRender = !1) : this.renderer = r.autoDetectRenderer(t.width, t.height, {
            backgroundColor: 1
        }),
    ...
    c.prototype.resize = function(t, e) {
        ...
        this.options.resizeMode === c.resizeModes.DEFUALT ? (this.renderer.resize(t, e),
        this.view.style.width = "auto",
        this.view.style.height = "auto") : this.this.options.resizeMode === c.resizeModes.CSS_RESIZE_PRESERVE_RATIO || this.options.resizeMode === c.resizeModes.CSS_RESIZE && (this.view.style.width = t + "px",
...
define("com/fido/ui/buttons/Button", ["require", "exports", "module", "signals"], function(t, e, i) {
    var r = t("signals")
      , n = function(t) {
        if (!t)
            throw "FIDO: Button view must not be undefined";
        this.view = t,
        this.onPress = new r,
        this.onDown = new r,
        this.onUp = new r,
...
define("com/nebulon/app/buttons/AabButton", ["require", "exports", "module", "PIXI", "com/fido/ui/buttons/Button", "com/fido/utils/ThreeSlice"], function(t, e, i) {
    ...
    s.prototype.createBackground = function(t) {
        ...
        i.position.y = 11;
        var n = !0;
        return n && (this.rollover = r.Sprite.fromFrame("3_slice_halftone_rollover.png"),
...
define("com/nebulon/app/buttons/AabLabelButton", ["require", "exports", "module", "PIXI", "./BaseAabButton", "com/fido/sound/SoundManager"], function(t, e, i) {
    var r = t("PIXI")
      , n = t("./BaseAabButton")
      , o = (t("com/fido/sound/SoundManager"),
    function(t, e) {
...
define("com/fido/utils/Utils", ["require", "exports", "module", "PIXI"], function(t, e, i) {
    ...
    n.formatName = function(t) {
        for (var e = t.split(" "), i = e.length - 1; i >= 0; i--)
            0 !== e[i].length && (wordArray = e[i].split(""),
...
define("com/nebulon/app/screens/LoaderScreen", ["require", "exports", "module", "PIXI", "../buttons/AabButton", "../buttons/AabLabelButton", "com/fido/ui/buttons/Button", "com/fido/system/Ticker", "com/fido/utils/FrameWait", "com/fido/system/Device", "com/fido/utils/Utils"], function(t, e, i) {
    ...
    o.prototype.update = function() {
        this.tick += .05,
        this.text.alpha = .6 + .5 * (Math.sin(this.tick) + 1) * .4
    }
    ,
    o.prototype.resize = function(t, e) {
        this.w = t,
...
define("com/nebulon/app/screens/Clouds", ["require", "exports", "module", "PIXI", "com/fido/system/Device", "com/fido/utils/Mini3d", "./Cloud", "com/fido/utils/Math2"], function(t, e, i) {
    ...
    a.prototype.update = function() {
        for (var t = 0; t < this.clouds.length; t++) {
            ...
            e.position3d.z < 300 ? e.alpha = e.position3d.z / 300 : e.alpha += .01 * (1 - e.alpha),
            e.position3d.z < 0 && (e.scaleRatio = 5,
            e.position3d.z += this.range,
            e.position3d.x = s.random(-4500, 4500),
            e.position3d.y = 1200 - Math.abs(.2 * e.position3d.x) + s.random(0, 200),
            e.rotation = e.position3d.x * -2e-4,
            e.alpha = 0,
            e.scaleOffset.x = s.random(.6, 1.4),
            e.scaleOffset.y = s.random(.9, 1.1),
            Math.random() < .5 && (e.scaleOffset.x *= -1))
        }
        this.mini3d.update(),
        this.count++,
        this.mini3d.view.rotation = .08 * Math.cos(.02 * this.count),
        this.mini3d.position3d.y = 200 * Math.sin(.03 * this.count),
        this.mini3d.position3d.y -= 50,
        this.mini3d.rotation3d.y = .2 * Math.sin(.02 * this.count * .5)
    }
    ,
    a.prototype.resize = function(t, e) {
        this.mini3d.view.x = t / 2,
        this.mini3d.view.y = e / 2
    }
    ,
    i.exports = a
}),
    ...
    t("com/fido/utils/Math2"))
      ...
      , s = function() {
        ...
        for (var e = 0; 50 > e; e++)
            ...
            blob.spring = new o,
            blob.rotationSpeed = n.random(-.1, .1),
            blob.anchor.set(.5),
...
define("com/nebulon/app/screens/MainScreen", ["require", "exports", "module", "PIXI", "com/fido/system/Device", "com/nebulon/app/screens/Clouds", "com/nebulon/app/screens/Stars", "com/nebulon/app/screens/MaskyMask", "com/fido/system/Ticker", "./SuperFilter", "./SpeedFilter"], function(t, e, i) {
    ...
    c.prototype.update = function() {
        this.autoCount++,
        this.autoCount > 60 ? (this.count += .01,
        this.posy.x = 1900 * Math.sin(this.count) * .25,
        this.posy.y = 1200 * Math.cos(2 * this.count) * .05,
        this.ratio += .1 * (1 - this.ratio)) : this.ratio += .1 * (0 - this.ratio);
...
var Stats = function() {
    ...
    c.appendChild(p); 74 > p.children.length; ) {
    ...
    return {
        ...
        begin: function() {
            ...
            h++,
            l > e + 1e3 && (o = Math.round(1e3 * h / (l - e)),
            s = Math.min(s, o),
            a = Math.max(a, o),
...
//window.ASSET_URL = "https://www.pixijs.com/header/assets/",
window.ASSET_URL = "",
config = {
...
hasCanvasSupport() ? require(["TWEEN", "EASEPACK", "CSSPACK", "HOWLER", "PIXI", "APP_root", "stats", "com/fido/system/Device"], function(t, e, i, r, n, o, s, a) {
    function h() {
